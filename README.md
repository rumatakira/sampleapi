## API generated from swagger OpenAPI 3.0 YAML file with OpenAPITools to SLIM 4 stub. Business logic implemented with Cycle ORM. In front is RoadRunner as HTTP server and balancer. PHP 7.4.10, PostgreSQL 12.4.
